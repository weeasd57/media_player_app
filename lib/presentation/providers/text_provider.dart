...
class TextProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _texts = {
    'ar': {
      ...
      'clean_library_subtitle': 'حذف الملفات المفقودة من المكتبة',
      'clean_library_confirmation': 'سيتم حذف جميع الملفات المفقودة من مكتبتك. لا يمكن التراجع عن هذا الإجراء.\n\nالمتابعة؟',
      'clean': 'تنظيف',
      'continue': 'متابعة',
      'library_cleaned_successfully': 'تم تنظيف المكتبة بنجاح',
      'scan_complete': 'اكتمل الفحص',
      'scan_complete_message': 'تم إكمال فحص الوسائط بنجاح.',
      'storage_info': 'معلومات التخزين',
      'storage_info_subtitle': 'عرض استخدام التخزين وإحصائيات الملفات',
      'storage_information': 'معلومات التخزين',
      'total_files': 'إجمالي الملفات',
      'favorites': 'المفضلة',
      'clear_all_data': 'مسح جميع البيانات',
      'clear_all_data_subtitle': 'حذف جميع قوائم التشغيل والتفضيلات',
      'clear_all_data_confirmation': 'سيتم حذف جميع قوائم التشغيل والمفضلة وبيانات التطبيق نهائياً. لا يمكن التراجع عن هذا الإجراء.\n\nهل أنت متأكد من المتابعة؟',
      'clear_all': 'مسح الكل',
      'all_data_cleared_successfully': 'تم مسح جميع البيانات بنجاح',
      'rate_app': 'قيم التطبيق',
      'rate_app_subtitle': 'قيمنا في متجر التطبيقات',
      'rating_feature_coming_soon': 'ميزة التقييم قريباً!',
      'report_bug': 'الإبلاغ عن خطأ',
      'report_bug_subtitle': 'ساعدنا في تحسين التطبيق',
      'bug_reporting_feature_coming_soon': 'ميزة الإبلاغ عن الأخطاء قريباً!',
      'privacy_policy_subtitle': 'اقرأ سياسة الخصوصية الخاصة بنا',
      'build': 'الإصدار',
      'app_description': 'مشغل وسائط حديث للملفات الصوتية ومقاطع الفيديو مع دعم قوائم التشغيل.',
      'automatically_repeat_playlists': 'إعادة تشغيل قوائم التشغيل تلقائياً',
      ...
      'times': 'مرة',
      'played_times': 'تم تشغيله {count} مرة',
      'no_playlists_available': 'لا توجد قوائم تشغيل متاحة',
      'files': 'ملفات',
      'added_to_playlist': 'تمت الإضافة إلى {name}',
    },
    ...
    'en': {
      ...
      'clean_library_subtitle': 'Remove missing files from library',
      'clean_library_confirmation': 'This will remove all missing files from your library. This action cannot be undone.\n\nContinue?',
      'clean': 'Clean',
      'continue': 'Continue',
      'library_cleaned_successfully': 'Library cleaned successfully',
      'scan_complete': 'Scan Complete',
      'scan_complete_message': 'Media scan has been completed successfully.',
      'storage_info': 'Storage Info',
      'storage_info_subtitle': 'View storage usage and file statistics',
      'storage_information': 'Storage Information',
      'total_files': 'Total Files',
      'favorites': 'Favorites',
      'clear_all_data': 'Clear All Data',
      'clear_all_data_subtitle': 'Remove all playlists and preferences',
      'clear_all_data_confirmation': 'This will permanently delete all your playlists, favorites, and app data. This action cannot be undone.\n\nAre you sure you want to continue?',
      'clear_all': 'Clear All',
      'all_data_cleared_successfully': 'All data cleared successfully',
      'rate_app': 'Rate App',
      'rate_app_subtitle': 'Rate us on the app store',
      'rating_feature_coming_soon': 'Rating feature coming soon!',
      'report_bug': 'Report Bug',
      'report_bug_subtitle': 'Help us improve the app',
      'bug_reporting_feature_coming_soon': 'Bug reporting feature coming soon!',
      'privacy_policy_subtitle': 'Read our privacy policy',
      'build': 'Build',
      'app_description': 'A modern media player for audio and video files with playlist support.',
