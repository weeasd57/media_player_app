            ...
            children: [
                    ...
                    children: [
                      ...
                      StreamBuilder<PlayerState>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          String statusText = 'جاهز'; // Keep Arabic for now
                          if (processingState == ProcessingState.loading) {
                            statusText = l10n.loadingLibrary;
                          } else if (processingState == ProcessingState.buffering) {
                            statusText = 'جاري التخزين المؤقت...'; // Keep Arabic for now
                          } else if (playerState?.playing == true) {
                            statusText = 'قيد التشغيل'; // Keep Arabic for now
                          } else if (processingState == ProcessingState.completed) {
                            statusText = l10n.done;
                          } else {
                            statusText = 'متوقف'; // Keep Arabic for now
                          }
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(_isLoading ? l10n.loadingLibrary : 'اختيار ملف صوتي'), // Keep Arabic for file picker
